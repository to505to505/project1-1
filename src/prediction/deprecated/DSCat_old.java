...
public class DSCat_old implements DS  {
    private double[][] data;
    ...
    public  DSCat_old(double[][] data, String course_name, String property_name, String[]courses_names, int course_col_num, int property_col_num ) {
