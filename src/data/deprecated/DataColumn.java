...
public class DataColumn {
    ...
    public static void main(String[] args) {
        ...
        DataColumn c = new DataColumn("c", DataType.DOUBLE);
    ...
    public void addDataElementOf(Object value) {
        ...
        else if(value instanceof Double && this.type == DataType.DOUBLE)
            elements.add(new DataElement(value));
        else if(value instanceof String && this.type == DataType.STRING)
            elements.add(new DataElement(value));
        else if(value instanceof Integer && this.type == DataType.INTEGER)
            elements.add(new DataElement(value));
